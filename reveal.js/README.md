...
To load these dependencies, reveal.js requires [head.js](https://headjs.com/) *(a script loading library)* to be loaded before reveal.js.
...
Presentations can be exported to PDF via a special print stylesheet. This feature requires that you use [Google Chrome](https://google.com/chrome) or [Chromium](https://www.chromium.org/Home) and to be serving the presentation from a webserver.
